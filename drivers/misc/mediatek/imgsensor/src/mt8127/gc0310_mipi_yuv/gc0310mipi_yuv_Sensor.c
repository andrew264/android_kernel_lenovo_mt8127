...
void GC0310MIPI_Sensor_Init(void)
{
  ...
  /////////////////////////////////////////////////
	...
	///////////////////   DNDD  /////////////////////
	///////////////////////////////////////////////// 
	GC0310MIPI_write_cmos_sensor(0x82,0x08); //08
	...
	GC0310MIPI_write_cmos_sensor(0x95,0x00); //65
...
*/
	...
	GC0310MIPI_write_cmos_sensor(0xd1,0x20); //34
	GC0310MIPI_write_cmos_sensor(0xd2,0x20); //34
	...
	GC0310MIPI_write_cmos_sensor(0x0c,0x50); //00
	GC0310MIPI_write_cmos_sensor(0x12,0x52); 
	GC0310MIPI_write_cmos_sensor(0x13,0x35); //38
	...
	GC0310MIPI_write_cmos_sensor(0x78,0xa0);//af// f0
...
/*
	...
	*/
	GC0310MIPI_write_cmos_sensor(0xd0,0x40);//44
	GC0310MIPI_write_cmos_sensor(0xd1,0xf4);//f8
	GC0310MIPI_write_cmos_sensor(0xd2,0xfd);//02

	GC0310MIPI_write_cmos_sensor(0xd3,0xec);//f8
	GC0310MIPI_write_cmos_sensor(0xd4,0x48);
	GC0310MIPI_write_cmos_sensor(0xd5,0xed);


	GC0310MIPI_write_cmos_sensor(0xd6,0x46);
	GC0310MIPI_write_cmos_sensor(0xd7,0xf8);
	GC0310MIPI_write_cmos_sensor(0xd8,0x05);
	GC0310MIPI_write_cmos_sensor(0xd9,0x08);
	GC0310MIPI_write_cmos_sensor(0xda,0x44);
	GC0310MIPI_write_cmos_sensor(0xdb,0xe9);
...
*/
	...
	*/
	GC0310MIPI_write_cmos_sensor(0xc4,0x90);
	GC0310MIPI_write_cmos_sensor(0xc5,0x69);
	GC0310MIPI_write_cmos_sensor(0xc6,0x69);
	GC0310MIPI_write_cmos_sensor(0xc7,0x20);//
	GC0310MIPI_write_cmos_sensor(0xc8,0x10);//
	GC0310MIPI_write_cmos_sensor(0xc9,0x10);//
...
BOOL GC0310MIPI_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:		
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x32);//35
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
		break;
