...
#define IMAGE_SENSOR_DRVNAME SENSOR_DRVNAME_SP0A20_YUV
...
*/
 ...
 #define SYSTEM_CLK                           (52*1000*1000)
  ...
  #define PIXEL_CLK							    (SYSTEM_CLK/8)		// 52/8 MHz
   ...
   #define SP0A20_VIDEO_NORMALMODE_FRAME_RATE							30		// Limitation for MPEG4 Encode Only
   #define SP0A20_VIDEO_NIGHTMODE_FRAME_RATE							15
	...
	#define SP0A20_SENSOR_NIGHT_MODE_GAIN					0x08	// Please refer to OV7670 Implementation Guide
    ...
    #define SP0A20_SENSOR_ID    (0x002b) 
