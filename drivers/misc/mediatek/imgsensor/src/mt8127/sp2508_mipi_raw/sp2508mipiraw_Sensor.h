...
#define SP2508MIPI_REAL_PV_WIDTH			  (1600) 
#define SP2508MIPI_REAL_PV_HEIGHT			  (1200) 
/* Real CAP Size, i.e. the size after all ISP processing (so already -4/-6), before MDP. */
#define SP2508MIPI_REAL_CAP_WIDTH			  (1600)  
#define SP2508MIPI_REAL_CAP_HEIGHT		  (1200) 
#define SP2508MIPI_REAL_VIDEO_WIDTH		  (1600) 
#define SP2508MIPI_REAL_VIDEO_HEIGHT		  (1200) 
...
#define SP2508MIPI_PV_LINE_LENGTH_PIXELS 			1160
#define SP2508MIPI_PV_FRAME_LENGTH_LINES			1241
#define SP2508MIPI_FULL_LINE_LENGTH_PIXELS 		1160
#define SP2508MIPI_FULL_FRAME_LENGTH_LINES		1241
#define SP2508MIPI_VIDEO_LINE_LENGTH_PIXELS 		1160
#define SP2508MIPI_VIDEO_FRAME_LENGTH_LINES		1241

#define SP2508MIPI_WRITE_ID (0x78)	//0x20
#define SP2508MIPI_READ_ID	(0x79)
