...
static int kxtj2_1009_remove_(void);
...
#endif 
	//g_gsensor_name = KXTJ2_1009_DEV_NAME;	//yutianqiang add for HardwareInfo 2014-5-8
	loaded = 0;
	GSE_LOG("%s: OK\n", __func__);    
	return 0;
