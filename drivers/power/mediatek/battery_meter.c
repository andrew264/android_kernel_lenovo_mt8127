...
///////////////////////////////////////////////////////////
kal_int32 g_Q_MAX_NEG_10[2]={Q_MAX_NEG_10,Q_MAX_NEG_10_2};
kal_int32 g_Q_MAX_NEG_10_H_CURRENT[2]={Q_MAX_NEG_10_H_CURRENT,Q_MAX_NEG_10_H_CURRENT_2};
kal_int32 g_Q_MAX_POS_0_H_CURRENT[2]={Q_MAX_POS_0_H_CURRENT,Q_MAX_POS_0_H_CURRENT_2};
kal_int32 g_Q_MAX_POS_25_H_CURRENT[2]={Q_MAX_POS_25_H_CURRENT,Q_MAX_POS_25_H_CURRENT_2};

kal_int32 g_Q_MAX_POS_50_H_CURRENT[2]={Q_MAX_POS_50_H_CURRENT,Q_MAX_POS_50_H_CURRENT_2};
kal_int32 g_Q_MAX_POS_0[2]={Q_MAX_POS_0,Q_MAX_POS_0_2};
kal_int32 g_Q_MAX_POS_25[2]={Q_MAX_POS_25,Q_MAX_POS_25_2};
kal_int32 g_Q_MAX_POS_50[2]={Q_MAX_POS_50,Q_MAX_POS_50_2};
...
#endif				/* battery info */
//int g_battery_id_voltage[2]={0,15}
...
//	printk("123!!!");
	...
	//	{
	//	mdelay(2);
	ret = IMM_GetOneChannelValue_Cali(13, &id_volt);//BATTERY_ID_CHANNEL_NUM
	if (ret != 0)
		printk("[fgauge_get_profile_id]id_volt read fail\n");
	else
		printk("[fgauge_get_profile_id]i=%d id_volt = %d\n",i, id_volt);
//	mdelay(3);
/*
...
*/
	if( id_volt < 100000)
		g_fg_battery_id =0;//  1 gong  battery
	else
		g_fg_battery_id =1;//  2 gong  battery
/*
	for (id = 0; id < 2; id++) {//TOTAL_BATTERY_NUMBER
...
{
#if defined(CONFIG_POWER_EXT)//no
//	printk("!!!334\n");
//	mdelay(2);
	return 0;
#else
